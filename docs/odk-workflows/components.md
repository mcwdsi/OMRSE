...
```
  <uri name="http://purl.obolibrary.org/obo/omrse/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/omrse-edit.obo)
for .obo formats: 

```
import: http://purl.obolibrary.org/obo/omrse/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/omrse.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
